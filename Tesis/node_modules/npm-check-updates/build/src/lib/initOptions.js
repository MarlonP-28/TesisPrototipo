    ...
    const resolvedOptions = {
        ...
        ...(options.prefix
            ? {
                ...
                prefix: await (((_e = package_managers_1.default[packageManager || '']) === null || _e === void 0 ? void 0 : _e.defaultPrefix) || package_managers_1.default.npm.defaultPrefix)(options),
            }
            : null),
        registryType: options.registryType || (((_f = options.registry) === null || _f === void 0 ? void 0 : _f.endsWith('.json')) ? 'json' : 'npm'),
    };
